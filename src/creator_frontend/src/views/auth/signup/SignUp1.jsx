...
import { creator_backend } from 'declarations/creator_backend'; // Import the backend actor
...
const JWTSignup = () => {
  ...
  const handleSignup = async (values, { setSubmitting }) => {
    ...
    try {
      ...
      await creator_backend.addClientWithPrincipal(
        Number(Date.now().toString()), // Using timestamp as ID, ensure it matches your ID logic
        name,
        username,
        password,
        phone_number,
        principal // Ensure `principal` is passed as a string
      );
